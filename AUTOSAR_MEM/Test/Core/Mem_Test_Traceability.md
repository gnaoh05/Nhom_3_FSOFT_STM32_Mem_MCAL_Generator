...
| `SWS_Mem_00052` | Runtime | `0x0105`, `0x0201`, `0x0202`, `0x0203`, `0x0204`, `0x0205`, `0x0304`, `0x0402`, `0x0403`, `0x0404`, `0x0502`, `0x0503`, `0x0504`, `0x0505`, `0x0602`, `0x0603`, `0x0604`, `0x0605`, `0x0703`, `0x0704`, `0x0705`, `0x0806`, `0x0807`, `0x0808`, `0x0809`, `0x0810`, `0x0811`, `0x0905` | Phân loại development error được target test thực thi |
...
| `SWS_Mem_10012` | Runtime | `0x0202`, `0x0203`, `0x0204`, `0x0205`, `0x0302`, `0x0303`, `0x0305`, `0x0401`, `0x0402`, `0x0403`, `0x0404`, `0x0405`, `0x0801`, `0x0904` | Hành vi API `Mem_Read()` |
...
| `SWS_Mem_00066` | Runtime | `0x0303`, `0x0401`, `0x0501`, `0x0601`, `0x0701`, `0x0901`, `0x0904` | Dịch vụ bất đồng bộ được thực thi trong `Mem_MainFunction()` |
| `SWS_Mem_00067` | Runtime | `0x0303`, `0x0401`, `0x0501`, `0x0601`, `0x0701` | Job thành công kết thúc với `MEM_JOB_OK` |
| `SWS_Mem_10013` | Runtime | `0x0501`, `0x0502`, `0x0503`, `0x0504`, `0x0505`, `0x0506`, `0x0902`, `0x0903`, `0x0905` | Hành vi API `Mem_Write()` |
...
| `SWS_Mem_00012` | Runtime | `0x0505`, `0x0905` | Độ dài không hợp lệ trong `Mem_Write()` |
| `SWS_Mem_00013` | Runtime | `0x0506` | `Mem_Write()` khi job trước đang pending |
| `SWS_Mem_10014` | Runtime | `0x0601`, `0x0602`, `0x0603`, `0x0604`, `0x0605`, `0x0606`, `0x0901` | Hành vi API `Mem_Erase()` |
...
| `SWS_Mem_00088` | Runtime | `0x0501`, `0x0601`, `0x0901`, `0x0902`, `0x0903` | Cơ chế xác nhận tính toàn vẹn và cô lập dữ liệu của upper layer |
